...
int main(int argc, char* argv[])
{
	...
	/* Test functions 'getHeaderNode', 'getFirstNode', 'getLastNode', 'advanceNode', 'backNode' and 'getNodeElem' */
	printf("Test functions 'getHeaderNode', 'getFirstNode', 'getLastNode', 'advanceNode', 'backNode' and 'getNodeElem'\n\n");
	printList(list);
